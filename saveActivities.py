...
cities = {"Mexico City":"MEX"}#"Santo Domingo":"DOM", "Santiago de los Caballeros":"DOM","Punta Cana":"DOM"}
activitiesIDs = []
for city in cities: 
...
for actId in activitiesIDs:
	...
	try:
		location = checkAPILocation(latLng[0],latLng[1],content['address'],"MEX","Mexico City")
